---
title: 'Movielens Capstone Project Report for HarvardX: PH125.9X'
...
**Motivation**
Our motivation is to complete the requirements for the  final marking for Data Science: Capstone HarvardX -  PH125.9x.
This assignment using the MovieLens data set was given to us. As a backgroun note this data set was originally collected by GroupLens Research.
Access to it is public and widely used by Data Science students and teachers.

**Goals**
The goals of the exercise is to answer the general question:**Can we predict movie ratings based on user preferance, age of a movie?**  

**Considerations, data set overall factors and methodology**

With the MovieLens data set and using penalized least squares, I have proceed to elaborate the following R script, which calculates the RMSE.
The RMSE takes into account as primaryu parameters: user ratings, movieId and the age of the movie.
...
4.1 Graphically explored the linear correlation coefficient, r-value
4.2 Calculate RMSE based on movieId, userId, and age of the movie.

**Analysis and Results**

Methology evaluation: post exploration the MovieLens data set through graphical representations and calculating RMSE, there was enough evidence to choose as the best set predictor for ratings two categories:  movieId, userId. Experimentally the analysis showsthe age of the movie didn't change the rmse.
